                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Pemeliharaan Layanan</h4>
                            </div>
                            <div class="table-responsive">
                                <table id="example" class="table text-nowrap text-center border-bottom" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th class="text-start">Service Type</th>
                                            <th class="text-center">Current Status</th>
                                            <th class="text-center">Maintenance Mode</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($dashboards as $row)
                                        <tr>
                                            <td class="text-start">{{ $row->dashboard_name }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="form-check d-flex justify-content-center">
                                                    @if($row->dashboard_status == 0)
                                                    <button class="btn btn-gradient-success btn-sm set-active" data-dashboard-id="{{ $row->dashboard_id }}">Set to Active</button>
                                                    @else
                                                    <button class="btn btn-gradient-warning btn-sm set-maintenance" data-dashboard-id="{{ $row->dashboard_id }}">Set to Maintenance</button>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
