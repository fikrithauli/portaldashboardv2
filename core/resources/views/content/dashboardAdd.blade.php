                                    ...
                                    <div class="card-body py-2 my-25">
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="basicInput">Name <small class="text-danger">*</small></label>
                                                    <small class="text-muted">eg.<i>broadband performance</i></small>
                                                    <input type="text" class="form-control" name="dashboard_name" id="basicInput" placeholder="Enter dashboard name" />
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="basicInput">Categories <small class="text-danger">*</small></label>
                                            ...
                                            <div class="col-xl-12 col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="basicInput">Description <small class="text-danger">*</small></label>
                                            ...
                                            <div class="col-xl-12 col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <select name="visualization_type" class="form-select" id="selectPlatform">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body py-2 my-25">
                                        ...
                                        <div class="d-flex">
                                            <a href="#" class="me-25">
                                                <img src="{{ asset('no-img.png') }}" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                            </a>
