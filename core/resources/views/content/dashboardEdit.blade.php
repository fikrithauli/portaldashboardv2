        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                ...
                <section id="basic-input">
                    <form action="{{ route('content-dashboard-update', ['id' => $dashboard->dashboard_id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        <h4 class="card-title">Dashboard Details</h4>
                                    </div>
                                    <div class="card-body py-2 my-25">
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="dashboard_name" id="basicInput" placeholder="Enter dashboard name" value="{{ $dashboard->dashboard_name }}" />
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="basicInput">Categories </label>
                                                    <select name="category_id" class="select2 form-select" id="select2-basic">
                                                        <option hidden>Select Categories</option>
                                                        @foreach($categories as $category)
                                                        <option value="{{ $category->category_id }}" {{ $category->category_id == $dashboard->category_id ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea name="description" class="form-control">{{ $dashboard->description }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-md-6 col-12">
                                                <div class="mb-2">
                                        ...
                                        <a href="{{ url('/content-dashboard') }}" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-header border-bottom">
                                        <h4 class="card-title">Dashboard Image</h4>
                                    </div>
                                    <div class="card-body py-2 my-25">
                                        <!-- header section -->
                                        <div class="d-flex">
                                            <a href="#" class="me-25">
                                                <img src="{{ asset('core/uploads/' . $dashboard->image) }}" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                            </a>
                                            <div class="d-flex align-items-end mt-75 ms-1">
                                                <div>
                                                    <label for="account-upload" class="btn btn-sm btn-primary mb-75 me-75">Change Image</label>
                                                    <input type="file" id="account-upload" name="image" hidden accept="image/*" />
                                                    <p class="mb-0">Allowed file: png, jpg, jpeg.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/ header section -->
