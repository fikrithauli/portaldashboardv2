...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <div class="action-button-container">
                            ...
                            <a href="#" class="action-button btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#truncateTableModal">
                                <i data-feather='trash'></i>&nbsp; Truncate
                            </a>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('content-dashboard-edit', ['id' => $row->dashboard_id]) }}">Update</a>
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteCategoryModal{{ $row->dashboard_id }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    @foreach ($dashboards as $row)
    <div class="modal fade" id="deleteCategoryModal{{ $row->dashboard_id }}" tabindex="-1" aria-labelledby="deleteCategoryModalTitle{{ $row->dashboard_id }}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 mx-50 pb-5">
                    <h1 class="text-center mb-1" id="deleteCategoryModalTitle{{ $row->dashboard_id }}">Delete Dashboard</h1>
                    <p class="text-center">Are you sure you want to delete this dashboard?</p>

                    <!-- Form untuk hapus -->
                    <form action="{{ route('dashboard.destroy', $row->dashboard_id) }}" method="POST">
                        @csrf
                        @method('DELETE')
    ...
    <div class="modal fade" id="truncateTableModal" tabindex="-1" aria-labelledby="truncateTableModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-transparent">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body px-sm-5 mx-50 pb-5">
                    <h1 class="text-center mb-1" id="truncateTableModalTitle">Truncate Table</h1>
                    <p class="text-center">Are you sure you want to truncate this table?</p>

                    <!-- Form untuk tindakan truncate -->
                    <form action="{{ route('truncate_table') }}" method="POST">
                        @csrf

                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-danger me-1 mt-1">Truncate</button>
                            <button type="button" class="btn btn-outline-secondary mt-1" data-bs-dismiss="modal">Cancel</button>
                        </div>
                    </form>
