...
<body class="alt-menu sidebar-noneoverflow">
            ...
            <div class="page-header">
               <nav class="breadcrumb-one" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active" aria-current="page"><a class="text-muted">Add Dashboard</a></li>
                  </ol>
               </nav>
            </div>
            <div class="row layout-top-spacing">
               ...
               <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                  <div class="account-settings-container layout-top-spacing">
                     <form id="general-info" class="section general-info" action="{{ route('create-dashboards') }}" method="post">
                        @csrf
                                                      ...
                                                      <div class="row">
                                                         <div class="col-sm-6">
                                                            <div class="form-group">
                                                               <label for="fullName">Dashboard Name <span class="text-danger">*</span></label>
                                                               <input type="text" name="name" class="form-control" id="fullName" placeholder="Enter Dashboard Name">
                                                            </div>
                                                         </div>
                                                         <div class="col-sm-6">
                                                            <div class="form-group">
                                                      ...
                                                      <div class="row">
                                                         <div class="col-sm-6">
                                                            <div class="form-group">
                                                               ...
                                                               <input type="text" name="description" class="form-control" id="jobTitle" placeholder="Enter Description">
                                                            </div>
                                                         </div>

                                                         <div class="col-sm-6">
                                                            <div class="form-group">
                                                               <label for="fullName">PIC <span class="text-danger">*</span></label>
                                                               <input type="text" name="pic" class="form-control" id="fullName" placeholder="Enter Dashboard PIC">
                                                            </div>
                                                         </div>
                                                      </div>
                                                   </div>
   ...
   <!-- <script>
      $(document).ready(function() {
         ...
         const clearResultsButton = $('#clearResults');
         ...
         clearResultsButton.on('click', function() {
            ...
            searchResults.hide(); // Sembunyikan hasil pencarian
         });
               ...
               $.ajax({
                  ...
                  success: function(response) {
                     ...
                     if (response.results.length > 0) {
                        ...
                        searchResults.empty();
                        const noDataCard = $('<div class="card mb-2"></div>');
                        const cardBody = $('<div class="card-body p-2"></div>');
                        cardBody.append('<p class="card-text">Data not found</p>');
                        noDataCard.append(cardBody);
                        searchResults.append(noDataCard);
