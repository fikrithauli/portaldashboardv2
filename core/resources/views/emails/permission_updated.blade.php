                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            <p><img src="{{ asset('tse.png') }}" width="100" alt=""></p>
                                            <br>
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">Your permissions have been updated for the following dashboard :</p>
                                            <ul style="margin-bottom: 24px;">
                                                @foreach ($dashboardNames as $dashboardName)
                                                <li>{{ $dashboardName }}</li>
                                                @endforeach
                                            </ul>
                                            <table cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #ea1a1a; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                        <a href="https://aagm.telkomsel.co.id/portaldashboard" target="_blank" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Check it out now &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
